  ...
  <div v-if="model" class="bg-gray-900/50 dark:bg-umbra/80 fixed inset-0 z-40">
    ...
    >
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-ebony border">
          <button
            type="button"
          ...
          <div class="p-4 md:p-5 text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">About CiteMe</h3>
            <p>{{ version }}</p>
          </div>
        </div>
      </div>
